...
<!--               修改按钮  绑定单击事件  将brand对象 传递给点击事件的方法-->
  ...
  export default {
    ...
    methods: {
      ...
      addBrand() {
        ...
        // 控制弹窗可见：
        this.show = true;
        //  新增时为null  没有显示的数据  把oldBrand变为null
        this.oldBrand = null;
      },
      // 通过改变show的状态实现弹窗可见   注意数据回显 接收数据赋值给oldBrand
      editBrand(oldBrand){
        // 根据品牌信息查询商品分类  商品分类回显 后台查询
